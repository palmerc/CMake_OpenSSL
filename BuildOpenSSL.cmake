...
function( BuildOpenSSL )
    ...
    foreach( TARGET_ARCHITECTURE ${TARGET_ARCHITECTURES} )
        ...
        set( OPENSSL_TARBALL ${OPENSSL_SOURCE_DIR}/openssl-1.0.2-latest.tar.gz )
        set( TIME_CONDITION )
        if( EXISTS ${OPENSSL_TARBALL} )
            set( TIME_CONDITION --time-cond ${OPENSSL_TARBALL} )
        endif()

        ### Download the tarball if it has changed using the current copy for the timestamp
        add_custom_command( OUTPUT ${OPENSSL_TARBALL}
                WORKING_DIRECTORY ${OPENSSL_SOURCE_DIR}
                DEPENDS ${CMAKE_RUN}
                COMMAND curl ${TIME_CONDITION} -o ${OPENSSL_TARBALL} --silent --location ${OPENSSL_URL}
        ...
        add_custom_command( OUTPUT
            ...
            DEPENDS ${OPENSSL_TARBALL}
            WORKING_DIRECTORY ${OPENSSL_SOURCE_DIR}
            COMMAND tar xfz openssl-1.0.2-latest.tar.gz --strip-components 1 -C ${OPENSSL_SOURCE_DIR}
